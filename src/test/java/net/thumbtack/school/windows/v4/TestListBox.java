...
public class TestListBox {
    ...
    public void testWrongState() {
        ...
        try {
            ...
            assertEquals(WindowErrorCode.WRONG_STATE, ex.getErrorString());
        }
        try {
    ...
    public void testSliceListBoxFailed() throws WindowException {
        ...
        try {
            ...
            assertEquals(WindowErrorCode.WRONG_INDEX, ex.getErrorString());
        }
        try {
        ...
        try {
            ...
            assertEquals(WindowErrorCode.EMPTY_ARRAY, ex.getErrorString());
        }
        if (failed) {
            fail();
        }
